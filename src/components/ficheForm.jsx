...
function ContratForm({ onClose, onSubmit }) {
    
}

function EvaluationForm({ onClose, onSubmit }) {
    
}

function FicheProcessusForm({ onClose, onSubmit }) {
    
}

export {FichePosteForm, ContratForm, EvaluationForm, FicheProcessusForm};