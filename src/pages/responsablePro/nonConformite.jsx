...
import LayoutRProcessus from "@/Layout/layoutRProcessus";
...
export default function NonConformite() {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        Toastify({
            text: "Action pour l'instant impossible. Le serveur n'est pas connecté",
            duration: 3000
        }).showToast();
                                ...
                                <div className={styles.paginationControls}>
                                    ...
                                    {[...Array(totalPages)].map((_, i) => (
                                        <button
                                            ...
                                            className={`${styles.pageNumber} ${currentPage === i + 1
