        ...
        <div className={styles.body}>
            <div className={styles.navbar}>
                ...
                <div className={styles.sectionsFocntionalites}>
                    <Link href="/responsableQ/dashboard"><div>Responsable Qualité</div></Link>
                    <Link href="/responsablePro/dashboard"><div>Responsable Processus</div></Link>
                    <Link href="/collborateurs/dashboard"><div>Utilisateurs</div></Link>
                </div>
